...
## Current build — 12 September 2026 (`shared-v1-review-fonts-2026-09-12`)
...
- Store-review identities: isolated review database, four reviewer roles, owner-run provisioning with private note + deployed-backend verification (`STORE_REVIEW_ACCESS.md`). Provisioned and verified in **preview** only; production provisioning is an owner action. No universal OTP or public reviewer account list exists.
